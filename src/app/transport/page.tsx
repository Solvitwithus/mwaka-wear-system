...
const filteredTransactions = transactions.filter(item => permissions[item.permission as keyof Permissions]);  
  return (
    ...
    <span className=' bg-[#006E7A] mb-2 px-4 ml-2 rounded-md mt-1 py-1 w-fit text-[#FF8C00] font-semibold text-sm'>Transport Operations</span>
    <div className='ml-2'>
      {
    ...
    <span className=' bg-[#006E7A] mb-2 px-4 ml-2 rounded-md mt-1 py-1 w-fit text-[#FF8C00] font-semibold text-sm'>Transport Reports and Inquiries</span>
    <div className='ml-2'>
    {
      ...
      <span className=' bg-[#006E7A] mb-2 px-4 ml-2 rounded-md mt-1 py-1 w-fit text-[#FF8C00] font-semibold text-sm'>Transport Setups and Company Configuration</span>
      <div className='ml-2'>
        {
