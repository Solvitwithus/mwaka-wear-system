...
const [useCustomEndLocation, setUseCustomEndLocation] = useState(false);
  ...
  // Build payload with conditional overrides
  const payload = {
    ...shift,
...
console.log(payload);
  ...
  {useCustomStartLocation ? (
    <input
      ...
      value={shift.customStartLocation}
      onChange={handleChange}
      className="bg-[#D9D9D9] h-6 rounded-md pl-2 placeholder-[#e48383]"
    />
  ) : (
  ...
  <button
    ...
    onClick={() => setUseCustomStartLocation(!useCustomStartLocation)}
  >
    {useCustomStartLocation ? "Use branch" : "Use custom"}
  </button>
</div>
  ...
  {useCustomEndLocation ? (
    <input
      ...
      placeholder="Custom end location"
      value={shift.customEndLocation}
      onChange={handleChange}
      className="bg-[#D9D9D9] h-6 rounded-md pl-2 placeholder-[#e48383]"
    />
  ) : (
  ...
  <button
    type="button"
    className="text-xs underline text-blue-700"
    onClick={() => setUseCustomEndLocation(!useCustomEndLocation)}
  >
    {useCustomEndLocation ? "Use branch" : "Use custom"}
  </button>
</div>
