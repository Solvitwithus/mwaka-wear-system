...
useEffect(() => {
  let filtered = salesEntries.filter((entry) => {
    if (entry.status !== "Prepayment-successful") return false; // filter first
...
router.push("/transport/prepaid-delivery/confirm-delivery")
  setTimeout(() => {
  ...
  return (
    <div className="bg-[#EFEFEF] m-1 rounded-md p-1 h-fit">
      ...
      <div className="flex flex-col border-black border-[1px] p-2 space-y-2 rounded-md">
           <h4 className="text-black font-medium text-base ml-1">Post-pay deliveries</h4>
