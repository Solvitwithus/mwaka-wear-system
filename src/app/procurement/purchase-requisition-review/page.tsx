...
const router = useRouter()
  ...
  useEffect(() => {
    let filtered = purchaseEntries.filter((entry) => {
      if(entry.status !== "purchase-requisition-entry") return false;
...
router.push("/procurement/purchase-requisition-review/review")
  setTimeout(() => {
  ...
  return (
    <div className="bg-[#EFEFEF] m-1 rounded-md p-1 h-fit">
      <h4 className="text-black font-medium text-base ml-1">Review Purchase Requisitions</h4>
