...
<div className='flex gap-1 justify-end'>
    ...
    <input type='text' readOnly className='my-[1px]  bg-[#D1CBCB] rounded-sm h-5'/>
            ...
            {/* Table Section */}
           <div className='border-[1px] border-black mx-1 rounded-md mb-2'>
  <h6 className='px-2 py-1 font-semibold text-sm text-black'>Order Items</h6>
  ...
  <h6 className='text-start px-2 text-sm font-serif font-bold py-1 cursor-pointer text-blue-600 hover:underline'>
    + Add Item
                      ...
                      {/* lower section */}
            <div className='border-[1px] border-black mx-1 rounded-md mb-2'>
<h6 className='text-center text-sm text-black font-semibold'>Order Delivery Details</h6>
{/* innerbody container */}
...
<div className='flex justify-end gap-2'>
    ...
    <input type='checkox' className='my-[1px] bg-[#D9D9D9] h-6 rounded-md'/>
</div>
</div>
</div>
            </div>
            ...
            <div className='flex gap-5 justify-center'>
                <button className='bg-[#4E803F] text-sm font-semibold px-3 py-[1px] text-white rounded-md'>Add Order</button>
                <button className='bg-[#E75D5D] text-sm px-3 py-[1px] font-semibold text-white rounded-md'>Cancel Order</button>
