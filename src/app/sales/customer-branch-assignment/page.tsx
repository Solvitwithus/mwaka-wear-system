...
//        alert(JSON.stringify(managers,null,2))
//       setClients(clientRes.data.clients);
//       alert(JSON.stringify(clients,null,2))
//     } catch (err) {
//       console.error("Failed to fetch managers or clients:", err);
//     }
//   }, []);
...
//                 {Array.isArray(managers) && managers.map((manager, idx) => (
...
//             <div className="flex justify-end gap-2 mb-1">
//               <label htmlFor="customer" className="text-sm text-black">Customer Name:</label>
//               <select
//                 name="customer"
//                 value={branch.customer}
//                 onChange={handleChange}
//                 className="bg-[#D9D9D9] h-6 rounded-md pl-2 text-sm text-black"
//               >
//                 <option value="">Select customer</option>
//                 {Array.isArray(clients) && clients.map((client, idx) => (
//                   <option key={idx} value={client.refNo}>{client.customerName}</option>
//                 ))}
//               </select>
//             </div>
