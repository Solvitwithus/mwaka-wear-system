...
const handleLocalDataParsing = (entry: any) => {
  ...
  localStorage.setItem("prepaidsaleEntryData", JSON.stringify(entry));
router.push("/sales/invoiceprepaidorders/process-prepaid-order")
  setTimeout(() => {
  ...
  return (
    <div className="bg-[#EFEFEF] m-1 rounded-md p-1 h-fit">
      <h4 className="text-black font-medium text-base ml-1">Prepaid Sales Invoices</h4>
