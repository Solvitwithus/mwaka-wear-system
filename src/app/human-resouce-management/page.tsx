...
if (loading) return (
  ...
  const menu =[
    ...
    {title:"Approve New Position Requisition",link:"/human-resouce-management/new-position-requisition-approval",permission:"ApproveNewPositionRequisition",image:StudIcon},
    {title:"Advertise Job Opening",link:"/human-resouce-management/advertise-job-opening",permission:"AdvertiseJobOpening",image:StudIcon},
  {title:"Add New Candidates",link:"/human-resouce-management/add-new-candidates",permission:"AddCandidate",image:StudIcon},
    {title:"Shortlist Candidates for Interview",link:"/human-resouce-management/shortlist-candidates-for-interview",permission:"ShortlistCandidatesforInterview",image:StudIcon},
    ...
    {title:"Leave Approval by HR",link:"/human-resouce-management/hr-leave-approval",permission:"LeaveApprovalbyHR",image:StudIcon},
    {title:"Leave Approval by Management",link:"/human-resouce-management/leave-final-approval",permission:"LeaveApprovalbyManagement",image:StudIcon},
    {title:"Training Request by Staff",link:"/human-resouce-management/training-request",permission:"TrainingRequestbyStaff",image:StudIcon},
    {title:"Performance Evaluation",link:"/human-resouce-management/performane-evaluation",permission:"PerformanceEvaluation",image:StudIcon},
    {title:"Training Requisition by HR",link:"/human-resouce-management/training-request",permission:"TrainingRequisitionbyHR",image:StudIcon},
