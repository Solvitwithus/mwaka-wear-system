/*
  ...
  - Added the required column `salespersonId` to the `SalesEntry` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_SalesEntry" ("clientId", "createdAt", "deliveryDetailsId", "grandTotal", "id", "remarks", "saleDate", "shipping", "status", "subtotal", "updatedAt") SELECT "clientId", "createdAt", "deliveryDetailsId", "grandTotal", "id", "remarks", "saleDate", "shipping", "status", "subtotal", "updatedAt" FROM "SalesEntry";
