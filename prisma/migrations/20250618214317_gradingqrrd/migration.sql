/*
  ...
  - You are about to drop the column `quantityToDispatch` on the `GradedItem` table. All the data in the column will be lost.
...
CREATE TABLE "new_GradedItem" (
    ...
    "qtyToDispatch" REAL NOT NULL DEFAULT 0,
