/*
  ...
  - You are about to alter the column `priceAdjustment` on the `SalesCategory` table. The data in that column could be lost. The data in that column will be cast from `String` to `Float`.
